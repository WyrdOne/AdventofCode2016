...
type TFloors = array[1..4] of integer;

const Part1Data: TFloors = (8,2,0,0);
  Part2Data: TFloors = (12,2,0,0);
...
begin
  Total := 0;
  for Idx:=1 to 3 do
    Total := Total + ((4-Idx)*Part1Data[Idx]*2-3);
  writeln('Part 1 = ', Total);
  Total := 0;
  for Idx:=1 to 3 do
    Total := Total + ((4-Idx)*Part2Data[Idx]*2-3);
